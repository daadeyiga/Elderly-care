        ...
        <div class="row">
            <div class="col-lg-3 col-md-4 col-sm-12">
                <figure class="sencare-logo-footer">
                    <a class="navbar-brand mr-0" href="index.html"><img src="./assets/images/logo.png" alt=""
                            class="img-fluid"></a>
                </figure>
                <p class="footer-text">Care That Feels Like Family</p>
            ...
            <div class="col-xl-3 col-lg-3 col-md-2 col-sm-12 d-lg-block d-none">
                <ul class="list-unstyled footer-list-ul">
                    ...
                    <li>
                        <a href="contact.php" class="text-decoration-none footer-link-p">
                            Contact us
                        </a>
                    </li>
                    <li>
                        <a href="login.php" class="text-decoration-none footer-link-p">
                            Login
                        </a>
                    </li>
                    <li>
                        <a href="signup.php" class="text-decoration-none footer-link-p">
                            Register
                        </a>
                    </li>
            ...
            <div class="col-lg-3 col-md-4 col-sm-12">
                <ul class="list-unstyled footer-list-ul contact-info-heading">
                    ...
                    <li class="mb-3">
                        <a href="mailto:info@spec.com" class="text-decoration-none">
                            info@spec.com
                        </a>
                    </li>
